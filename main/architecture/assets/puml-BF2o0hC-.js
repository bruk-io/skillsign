...
SkillsignCliVerificationEngine .[#8D8D8D,thickness=2].> Rekor : "<color:#8D8D8D>Confirms log entry exists and digest matches in --strict mode<color:#8D8D8D>"
...
SkillsignCli .[#8D8D8D,thickness=2].> SigstoreDex : "<color:#8D8D8D>Opens browser for OAuth login via Dex — user picks Google, GitHub, or Microsoft (interactive path)<color:#8D8D8D>"
...
SkillsignCliVerificationEngine .[#8D8D8D,thickness=2].> Rekor : "<color:#8D8D8D>Confirms rekor_log_id exists, digest matches, and timestamp valid (--strict mode)<color:#8D8D8D>"
SkillsignCliVerificationEngine .[#8D8D8D,thickness=2].> SkillsignCliPolicyEngine : "<color:#8D8D8D>Passes verified signer identity, rekor_timestamp, and skill_id [Phase 2]<color:#8D8D8D>"
